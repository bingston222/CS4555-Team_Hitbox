...
Shader "TidalFlask/Custom Normal UV Mask Switch URP U6"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BaseTextureMasks5 = input.ase_texcoord9.xy;
				...
				float2 uv2_NormalTexture17 = input.ase_texcoord9.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 color6 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_BaseTextureMasks5 = input.ase_texcoord4.xy;
				float4 tex2DNode5 = tex2D( _BaseTextureMasks, uv_BaseTextureMasks5 );
				float4 lerpResult10 = lerp( color6 , _PrimaryColor , tex2DNode5.r);
				float4 lerpResult11 = lerp( lerpResult10 , _SecondaryColor , tex2DNode5.g);
				float4 lerpResult12 = lerp( lerpResult11 , _TertiaryColor , tex2DNode5.b);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float4 color6 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_BaseTextureMasks5 = input.ase_texcoord2.xy;
				float4 tex2DNode5 = tex2D( _BaseTextureMasks, uv_BaseTextureMasks5 );
				float4 lerpResult10 = lerp( color6 , _PrimaryColor , tex2DNode5.r);
				float4 lerpResult11 = lerp( lerpResult10 , _SecondaryColor , tex2DNode5.g);
				float4 lerpResult12 = lerp( lerpResult11 , _TertiaryColor , tex2DNode5.b);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv2_NormalTexture17 = input.ase_texcoord5.xy;
				float3 unpack17 = UnpackNormalScale( tex2D( _NormalTexture, uv2_NormalTexture17 ), _NormalStrength );
				unpack17.z = lerp( 1, unpack17.z, saturate(_NormalStrength) );
...
ASEEND*/
//CHKSM=1A7A80EB242581FBF6FB2AFB4F2A75436716D08D