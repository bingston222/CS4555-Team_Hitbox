...
Shader "TidalFlask/Custom Normal UV Mask Switch URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BaseTextureMasks5 = IN.ase_texcoord8.xy;
				...
				float2 uv2_NormalTexture17 = IN.ase_texcoord8.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 color6 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_BaseTextureMasks5 = IN.ase_texcoord4.xy;
				float4 tex2DNode5 = tex2D( _BaseTextureMasks, uv_BaseTextureMasks5 );
				float4 lerpResult10 = lerp( color6 , _PrimaryColor , tex2DNode5.r);
				float4 lerpResult11 = lerp( lerpResult10 , _SecondaryColor , tex2DNode5.g);
				float4 lerpResult12 = lerp( lerpResult11 , _TertiaryColor , tex2DNode5.b);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 color6 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_BaseTextureMasks5 = IN.ase_texcoord2.xy;
				float4 tex2DNode5 = tex2D( _BaseTextureMasks, uv_BaseTextureMasks5 );
				float4 lerpResult10 = lerp( color6 , _PrimaryColor , tex2DNode5.r);
				float4 lerpResult11 = lerp( lerpResult10 , _SecondaryColor , tex2DNode5.g);
				float4 lerpResult12 = lerp( lerpResult11 , _TertiaryColor , tex2DNode5.b);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv2_NormalTexture17 = IN.ase_texcoord5.xy;
				float3 unpack17 = UnpackNormalScale( tex2D( _NormalTexture, uv2_NormalTexture17 ), _NormalStrength );
				unpack17.z = lerp( 1, unpack17.z, saturate(_NormalStrength) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;28;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=C3E1D5E9B4FCF843641AE87316D8FC90FEE8B953